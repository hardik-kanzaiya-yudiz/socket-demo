...
<script>
    ...
    // console.log(socket);
    let sendUserId = "{{ auth()->user()->id }}";
    let recieveUserId = "2"; // this is take static for this time ::::pending => get-active-class-user id
    let sendUserType = "admin";
    let recieveUserType = "user";
